...
mkdir -p /app/memory_db /app/sheets_index_db /app/logs /app/credentials 2>/dev/null || true
...
if [ "$(id -u)" = "0" ]; then
    ...
    chown -R ${APPUSER_UID}:${APPUSER_GID} /app/memory_db /app/sheets_index_db /app/logs /app/credentials 2>/dev/null || true
    # Ensure directories are writable
    chmod -R 755 /app/memory_db /app/sheets_index_db /app/logs /app/credentials 2>/dev/null || true
